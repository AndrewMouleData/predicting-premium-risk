...
Purpose:
Client-side ingestion of all observations from data/raw/casualties_master.csv into the raw.casualties table.
...
> psql -d predicting_premium_risk -f sql/01_raw/06_ingest_raw_casualties.sql
