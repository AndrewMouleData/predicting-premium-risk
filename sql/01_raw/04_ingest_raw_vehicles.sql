/*
  04_ingest_raw_vehicles.sql

Purpose:
Client-side ingestion of all observations from data/raw/vehicles_master.csv into the raw.vehicles table.
...
> psql -d predicting_premium_risk -f sql/01_raw/04_ingest_raw_vehicles.sql
...
\copy raw.vehicles FROM 'data/raw/vehicles_master.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', NULL '', QUOTE '"');
